import jaxtyping
if not hasattr(jaxtyping, '_decorator'):
    class _DummyDecorator: pass
    jaxtyping._decorator = _DummyDecorator()
if not hasattr(jaxtyping._decorator, '_check_dataclass_annotations'):
    jaxtyping._decorator._check_dataclass_annotations = lambda cls, *args, **kwargs: cls
import contextlib
